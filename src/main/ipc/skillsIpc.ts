...
export function registerSkillsIpc(): void {
  ...
  ipcMain.handle('skills:getFile', async (_event, args: { skillDir: string; fileName: string }) => {
    try {
  ...
  ipcMain.handle(
    'skills:agrInstall',
    async (_event, args: { handle: string; scope: 'global' | 'project'; projectPath?: string }) => {
      try {
  ...
  ipcMain.handle('skills:moveSkill', async (_event, args: { oldDir: string; newDir: string }) => {
    try {
